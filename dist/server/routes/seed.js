...
router.post("".concat(path_1.Path.Root), function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        try {
            ...
            page = req.body.page;
            users = (0, generateUsers_1.generateUsers)(language, amount, seed, page);
